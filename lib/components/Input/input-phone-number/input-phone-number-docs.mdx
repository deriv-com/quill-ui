...
| inputSize          | "sm", "md" ,"lg"                | "md"            | Sets the size of the input field.                                           |
...
| placeholder        | string                          | "00 0000 0000"  | Placeholder text for the input field.                                       |
| formatProps        | object                          | { format: "## #### ####" } | Props for formatting the input value.                                |
